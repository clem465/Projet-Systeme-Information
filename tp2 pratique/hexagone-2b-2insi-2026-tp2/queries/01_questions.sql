...
SELECT client_name FROM client WHERE NOT EXISTS (
    SELECT gameboard_id FROM gameboard
    EXCEPT
    SELECT gameboard_id FROM purchase WHERE purchase.client_id = client.client_id
);
...
SELECT client_name FROM client WHERE NOT EXISTS (
    SELECT gameboard_id FROM gameboard WHERE category = 'deck building'
    EXCEPT
    SELECT gameboard_id FROM purchase WHERE purchase.client_id = client.client_id
);